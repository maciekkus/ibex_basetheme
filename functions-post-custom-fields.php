            ...
            switch ($field['type']) {
	            ...
	            case 'select':
	                ...
	                foreach ($field['options'] as $name=>$value) {
	                    echo '<option', $meta == $value ? ' selected="selected"' : '', ' value="',$value,'">', $name, '</option>';
	                }
	                echo '</select>';
	                break;
	            case 'radio':
	        	...
	        	case 'custom-hidden': 
	                echo '<textarea type="hidden" style="display:none;" name="', $field['id'], '" id="', $field['id'], '">', $meta ? $meta : '','</textarea>';
	        		echo $field['std'];
	        		break;
